...
var htm = wake.findFile('../../mb/web', 'html',true);
...
for(var i in htmMap){
	...
	// }
	str.push("<a href='#"+htmMap[i].replace(/^\.\.\/\.\.\/mb/g,"")+"?css=1&js=1'>"+"title"+":"+i+"</a><br>");
	
}
console.log(str.join(""))
wake.writeData("../../mb/map.html","<div style='background: #fff;color:#000;'>"+str.join("")+"</div>");